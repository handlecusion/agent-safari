...
TOOL_CONTRACTS: list[dict[str, Any]] = [
    ...
    {"name": "upload", "description": "Set files on an <input type=file> by selector or snapshot ref via the WebKit open panel.", "cli": ["upload", "<selector-or-ref>", "<path>", "[<path>...]", "[--tab <id>]"], "input": ["selector", "paths", "tab"], "result": ["selector", "files", "fileCount", "changeEventSynthesized", "method", "fallbackUsed", "strategy", "tabId"]},
